...
/** Bloc contact commun : une question sur ce document ? Le message s'écrit dans l'app (aucune adresse affichée). */
      ...
      <View style={styles.contact}>
        ...
        <View style={styles.flex1}>
          ...
          <Text style={[styles.sectionSummary, { color: colors.textSecondary }]}>
            Écris à l’équipe Mova directement depuis l’application, en quelques lignes.
          </Text>
        </View>
      </View>
      <View style={styles.contact}>
        <PressableScale
          ...
          accessibilityLabel="Écrire à Mova"
