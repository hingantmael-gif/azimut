/**
 * Extraction soignée — Or 2 uniquement (hexagone).
 * node scripts/process-or-2.mjs
 */
...
const SOURCE = join(root, 'assets/ranks/sources/frames/or-2.png');
const OUT = join(root, 'assets/ranks/badges/or-2.png');
...
async function main() {
  ...
  console.log(`✓ or-2.png → ${meta.width}×${meta.height}`);
}
