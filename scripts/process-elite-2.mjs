/**
 * Extraction soignée — Élite 2 uniquement (bouclier violet + ailes).
 * node scripts/process-elite-2.mjs
 */
...
const SOURCE = join(root, 'assets/ranks/sources/frames/elite-2.png');
const OUT = join(root, 'assets/ranks/badges/elite-2.png');
...
async function main() {
  ...
  console.log(`✓ elite-2.png → ${meta.width}×${meta.height}`);
}
