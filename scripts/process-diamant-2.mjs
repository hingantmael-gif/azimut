/**
 * Extraction soignée — Diamant 2 uniquement (cristal bleu).
 * node scripts/process-diamant-2.mjs
 */
...
const SOURCE = join(root, 'assets/ranks/sources/frames/diamant-2.png');
const OUT = join(root, 'assets/ranks/badges/diamant-2.png');
...
async function main() {
  ...
  console.log(`✓ diamant-2.png → ${meta.width}×${meta.height}`);
}
