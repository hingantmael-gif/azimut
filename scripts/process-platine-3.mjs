/**
 * Extraction soignée — Platine 3 uniquement.
 * node scripts/process-platine-3.mjs
 */
...
const SOURCE = join(root, 'assets/ranks/sources/frames/platine-3.png');
const OUT = join(root, 'assets/ranks/badges/platine-3.png');
...
function isEmblemPixel(r, g, b) {
  return isPlatinum(r, g, b) || isNavyCenter(r, g, b) || isCyanGem(r, g, b) || isBlack(r, g, b);
}
...
async function main() {
  ...
  console.log(`✓ platine-3.png → ${meta.width}×${meta.height}`);
}
