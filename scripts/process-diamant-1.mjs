/**
 * Extraction soignée — Diamant 1 uniquement (cristal + ailes).
 * node scripts/process-diamant-1.mjs
 */
...
const SOURCE = join(root, 'assets/ranks/sources/frames/diamant-1.png');
const OUT = join(root, 'assets/ranks/badges/diamant-1.png');
...
async function main() {
  ...
  console.log(`✓ diamant-1.png → ${meta.width}×${meta.height}`);
}
