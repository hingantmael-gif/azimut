/**
 * Extraction soignée — Platine 2 uniquement.
 * node scripts/process-platine-2.mjs
 */
...
const SOURCE = join(root, 'assets/ranks/sources/frames/platine-2.png');
const OUT = join(root, 'assets/ranks/badges/platine-2.png');
...
/** Éclairs / motifs cyan clairs au centre. */
...
async function main() {
  ...
  console.log(`✓ platine-2.png → ${meta.width}×${meta.height}`);
}
