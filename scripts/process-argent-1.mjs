/**
 * Extraction soignée — Argent 1 uniquement (lauriers + gemmes).
 * node scripts/process-argent-1.mjs
 */
...
const SOURCE = join(root, 'assets/ranks/sources/frames/argent-1.png');
const OUT = join(root, 'assets/ranks/badges/argent-1.png');
...
async function main() {
  ...
  console.log(`✓ argent-1.png → ${meta.width}×${meta.height}`);
}
