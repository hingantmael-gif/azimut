/**
 * Extraction soignée — Bronze 2 uniquement.
 * node scripts/process-bronze-2.mjs
 */
...
const SOURCE = join(root, 'assets/ranks/sources/frames/bronze-2.png');
const OUT = join(root, 'assets/ranks/badges/bronze-2.png');
...
/** Retire les pixels quasi-blancs / franges claires restantes (anti-aliasing). */
...
/** Retire argent / texte / aperçu rang inférieur collés en bas après découpe. */
...
async function main() {
  ...
  console.log(`✓ bronze-2.png → ${meta.width}×${meta.height}`);
}
