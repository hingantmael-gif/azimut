/**
 * Extraction soignée — Élite 3 uniquement (bouclier violet + ailes).
 * node scripts/process-elite-3.mjs
 */
...
const SOURCE = join(root, 'assets/ranks/sources/frames/elite-3.png');
const OUT = join(root, 'assets/ranks/badges/elite-3.png');
...
async function main() {
  ...
  console.log(`✓ elite-3.png → ${meta.width}×${meta.height}`);
}
